...
class BaseInvoice(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Invoice']] = 'Invoice'  # pyright: ignore[reportIncompatibleVariableOverride]
...
class BaseRecurringInvoice(_PrismaModel):
    __prisma_model__: ClassVar[Literal['RecurringInvoice']] = 'RecurringInvoice'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.RecurringInvoiceActions[_PrismaModelT]':
        from .client import get_client

        return actions.RecurringInvoiceActions[_PrismaModelT](client or get_client(), cls)
...
class BaseRepeatRule(_PrismaModel):
    __prisma_model__: ClassVar[Literal['RepeatRule']] = 'RepeatRule'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.RepeatRuleActions[_PrismaModelT]':
        from .client import get_client

        return actions.RepeatRuleActions[_PrismaModelT](client or get_client(), cls)
