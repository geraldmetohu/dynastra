...
SCHEMA_PATH = Path('C:/Users/User/OneDrive/Desktop/Gems/dynastratech/prisma_schema/schema.prisma')
...
class Prisma(AsyncBasePrisma):
    ...
    recurringinvoice: 'actions.RecurringInvoiceActions[models.RecurringInvoice]'
    message: 'actions.MessageActions[models.Message]'
    repeatrule: 'actions.RepeatRuleActions[models.RepeatRule]'
    ...
    def __init__(
        ...
        *,
        ...
        self.recurringinvoice = actions.RecurringInvoiceActions[models.RecurringInvoice](self, models.RecurringInvoice)
        self.message = actions.MessageActions[models.Message](self, models.Message)
        self.repeatrule = actions.RepeatRuleActions[models.RepeatRule](self, models.RepeatRule)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/User/OneDrive/Desktop/Gems/dynastratech/prisma_schema/schema.prisma',
        }
...
class Batch:
    ...
    recurringinvoice: 'RecurringInvoiceBatchActions'
    message: 'MessageBatchActions'
    repeatrule: 'RepeatRuleBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.recurringinvoice = RecurringInvoiceBatchActions(self)
        self.message = MessageBatchActions(self)
        self.repeatrule = RepeatRuleBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class RecurringInvoiceBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
